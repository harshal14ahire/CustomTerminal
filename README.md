...
I.	<display> <.extension>
a.	Display all files with the specified extension in the current directory.
II.	<displaynf>
a.	Print a list of all files in the current directory.
III.	<displaynd>
a.	Print a list of all directories in the current working directory.
IV.	System Utilities
V.	<uinfo>
a.	Print system user information, such as the username and operating system details.
VI.	<df>
a.	Display disk space usage.
VII.	<free>
a.	Display memory usage statistics.
...
4.	cd custom-terminal
5.	Compile and run the project (if applicable): 
6.	javac Main.java
7.	java Main
8.	Use the commands listed above to perform desired operations.
System Requirements
...
•	Email: harshal14ahire@gmail.com
